...
public class BWCrafting 
{
	...
	{
		GameRegistry.addShapedRecipe(new ItemStack(BWRegistry.axle), "M", "R", "M", 'M', new ItemStack(BWRegistry.woodMoulding, 1, 32767), 'R', BWRegistry.rope);
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BWRegistry.gearbox), "SGS", "GLG", "SGS", 'L', new ItemStack(BWRegistry.material, 1, 35), 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767), 'G', "gearWood"));
		for(int i = 0; i < 6; i++)
		{
			addSawRecipe(new ItemStack(BWRegistry.material, 2, 0), BWRegistry.woodCorner, i);
			addSawRecipe(new ItemStack(BWRegistry.woodCorner, 2, i), BWRegistry.woodMoulding, i);
			addSawRecipe(new ItemStack(BWRegistry.woodMoulding, 2, i), BWRegistry.woodSiding, i);
			GameRegistry.addShapelessRecipe(new ItemStack(BWRegistry.woodMoulding, 1, i), new ItemStack(BWRegistry.woodCorner, 1, i), new ItemStack(BWRegistry.woodCorner, 1, i));
			GameRegistry.addShapelessRecipe(new ItemStack(BWRegistry.woodSiding, 1, i), new ItemStack(BWRegistry.woodMoulding, 1, i), new ItemStack(BWRegistry.woodMoulding, 1, i));
			GameRegistry.addShapelessRecipe(new ItemStack(Blocks.PLANKS, 1, i), new ItemStack(BWRegistry.woodSiding, 1, i), new ItemStack(BWRegistry.woodSiding, 1, i));
			GameRegistry.addShapedRecipe(new ItemStack(BWRegistry.woodTable, 4, i), "SSS", " M ", " M ", 'S', new ItemStack(BWRegistry.woodSiding, 1, i), 'M', new ItemStack(BWRegistry.woodMoulding, 1, i));
			GameRegistry.addShapedRecipe(new ItemStack(BWRegistry.woodBench, 4, i), "SSS", " M ", 'S', new ItemStack(BWRegistry.woodSiding, 1, i), 'M', new ItemStack(BWRegistry.woodMoulding, 1, i));
		}
		for(int i = 0; i < 4; i++)
		...
		GameRegistry.addShapedRecipe(new ItemStack(Blocks.BOOKSHELF), "SSS", "BBB", "SSS", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767), 'B', Items.BOOK);
		GameRegistry.addShapedRecipe(new ItemStack(Blocks.CHEST), "SSS", "S S", "SSS", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Blocks.NOTEBLOCK), "SSS", "SRS", "SSS", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767), 'R', "dustRedstone"));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(Blocks.JUKEBOX), "SSS", "SDS", "SSS", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767), 'D', "gemDiamond"));
		GameRegistry.addShapedRecipe(new ItemStack(Blocks.LADDER, 4), "M M", "MMM", "M M", 'M', new ItemStack(BWRegistry.woodMoulding, 1, 32767));
		GameRegistry.addShapedRecipe(new ItemStack(Blocks.TRAPDOOR, 2), "SSS", "SSS", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767));
		GameRegistry.addShapedRecipe(new ItemStack(Items.SIGN, 3), "S", "M", 'S', new ItemStack(BWRegistry.woodSiding, 1, 32767), 'M', new ItemStack(BWRegistry.woodMoulding, 1, 32767));
		GameRegistry.addShapelessRecipe(new ItemStack(Items.STICK), new ItemStack(BWRegistry.woodMoulding, 1, 32767));
		...
		GameRegistry.addShapedRecipe(new ItemStack(Items.ITEM_FRAME), "MMM", "MLM", "MMM", 'M', new ItemStack(BWRegistry.woodMoulding, 1, 32767), 'L', new ItemStack(BWRegistry.material, 1, 32));
		GameRegistry.addShapedRecipe(new ItemStack(Items.BOWL, 6), "S S", " S ", 'S', new ItemStack(BWRegistry.woodMoulding, 1, 32767));
	...
	private static void addVanillaRecipes()
	{
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BWRegistry.bellows), new Object[] {"WWW", "LLL", "BGB", Character.valueOf('W'), new ItemStack(BWRegistry.woodSiding, 1, 32767), Character.valueOf('L'), new ItemStack(BWRegistry.material, 1, 33), Character.valueOf('B'), new ItemStack(BWRegistry.material, 1, 9), Character.valueOf('G'), "gearWood"}));
		...
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BWRegistry.singleMachines, 1, 5), new Object[] {"LLL", "SCS", "SWS", Character.valueOf('L'), new ItemStack(BWRegistry.woodSiding, 1, 32767), Character.valueOf('S'), "stone", Character.valueOf('W'), "gearWood", Character.valueOf('C'), Items.CLOCK}));
		...
		//GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BWRegistry.grate, 4, 0), new Object[] {"WSW", "WSW", Character.valueOf('S'), "stickWood", Character.valueOf('W'), new ItemStack(BWRegistry.woodMoulding, 1, 32767)}));
		GameRegistry.addRecipe(new ShapedOreRecipe(new ItemStack(BWRegistry.slats, 4, 0), new Object[]{"SS", "SS", Character.valueOf('S'), new ItemStack(BWRegistry.woodMoulding, 1, 32767)}));
		for(int i = 1; i < 6; i++)
		{
	...
	private static void addCauldronRecipes()
	{
		...
		addStokedCauldronRecipe(new ItemStack(BWRegistry.material, 2, 12), new ItemStack[] {new ItemStack(Items.LEATHER_HELMET, 1, 32767)});
		addStokedCauldronRecipe(new ItemStack(BWRegistry.material, 2, 12), new ItemStack[] {new ItemStack(Items.LEATHER_BOOTS, 1, 32767)});
		addStokedCauldronRecipe(new ItemStack(BWRegistry.material, 3, 12), new ItemStack[] {new ItemStack(Items.LEATHER_LEGGINGS, 1, 32767)});
		addStokedCauldronRecipe(new ItemStack(BWRegistry.material, 2, 12), new ItemStack[] {new ItemStack(Items.LEATHER_CHESTPLATE, 1, 32767)});
	...
	private static void addCrucibleRecipes()
	{
		...
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 3, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_PICKAXE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 2, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_HOE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 2, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_SWORD, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 1, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_SHOVEL, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 3, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_AXE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 4, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_BOOTS, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 8, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_HORSE_ARMOR, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 5, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_HELMET, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 8, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_CHESTPLATE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.GOLD_INGOT, 7, 0), new ItemStack[] {new ItemStack(Items.GOLDEN_LEGGINGS, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 3, 0), new ItemStack[] {new ItemStack(Items.IRON_PICKAXE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 2, 0), new ItemStack[] {new ItemStack(Items.IRON_HOE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 2, 0), new ItemStack[] {new ItemStack(Items.IRON_SWORD, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 1, 0), new ItemStack[] {new ItemStack(Items.IRON_SHOVEL, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 3, 0), new ItemStack[] {new ItemStack(Items.IRON_AXE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 4, 0), new ItemStack[] {new ItemStack(Items.IRON_BOOTS, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 8, 0), new ItemStack[] {new ItemStack(Items.IRON_HORSE_ARMOR, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 5, 0), new ItemStack[] {new ItemStack(Items.IRON_HELMET, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 8, 0), new ItemStack[] {new ItemStack(Items.IRON_CHESTPLATE, 1, 32767)});
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 7, 0), new ItemStack[] {new ItemStack(Items.IRON_LEGGINGS, 1, 32767)});
		...
		addStokedCrucibleRecipe(new ItemStack(Items.IRON_INGOT, 31), new ItemStack[] {new ItemStack(Blocks.ANVIL, 1, 32767)});
		...
		addStokedCrucibleRecipe(new ItemStack(Blocks.GLASS), new ItemStack[] {new ItemStack(Blocks.SAND, 1, 32767)});
	...
	public static void addSawRecipe(ItemStack output, Block block, int meta) {
		SawInteraction.addBlock(block, meta, output);
	}
