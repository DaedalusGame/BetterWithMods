...
public class StokedCauldron {
    ...
    public static void remove(IItemStack output) {
        MineTweakerAPI.apply(new BulkRemove("cauldronStoked", StokedCauldronManager.getInstance(),InputHelper.toStack(output), ItemStack.EMPTY));
    }

    @ZenMethod
    public static void remove(IItemStack output, IIngredient[] inputs) {
        MineTweakerAPI.apply(new BulkRemove("cauldronStoked", StokedCauldronManager.getInstance(),InputHelper.toStack(output), ItemStack.EMPTY, InputHelper.toObjects(inputs)));
    }
}
