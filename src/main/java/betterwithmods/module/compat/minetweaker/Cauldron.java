...
public class Cauldron {
    ...
    public static void add(IItemStack output, @Optional IItemStack secondaryOutput, @NotNull IIngredient[] inputs) {
        ...
        MineTweakerAPI.apply(new BulkAdd(CauldronRecipeCategory.UID, CauldronManager.getInstance(), r));

    }

    @ZenMethod
    public static void remove(IItemStack output) {
        MineTweakerAPI.apply(new BulkRemove(CauldronRecipeCategory.UID, CauldronManager.getInstance(), InputHelper.toStack(output), ItemStack.EMPTY));
    }

    @ZenMethod
    public static void remove(IItemStack output, @NotNull IIngredient[] inputs) {
        MineTweakerAPI.apply(new BulkRemove(CauldronRecipeCategory.UID, CauldronManager.getInstance(), InputHelper.toStack(output), ItemStack.EMPTY, InputHelper.toObjects(inputs)));
    }
