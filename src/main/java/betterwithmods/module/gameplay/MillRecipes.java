...
public class MillRecipes extends Feature {
    ...
    public void init(FMLInitializationEvent event) {
        addMillRecipe(new ItemStack(Items.STRING, 10), getDye(EnumDyeColor.RED,3),new Object[]{new ItemStack(BWMBlocks.WOLF)});
        ...
        addMillRecipe(getDye(EnumDyeColor.WHITE,6), new ItemStack(Items.BONE));
        addMillRecipe(getDye(EnumDyeColor.WHITE,10), new ItemStack(Items.SKULL, 1, 0));
        addMillRecipe(getDye(EnumDyeColor.WHITE,10), new ItemStack(Items.SKULL, 1, 1));
        addMillRecipe(getDye(EnumDyeColor.WHITE,9), new ItemStack(Blocks.BONE_BLOCK));
        ...
        //Dyes
        addMillRecipe(getDye(EnumDyeColor.RED,2), new ItemStack(Items.BEETROOT));
        addMillRecipe(getDye(EnumDyeColor.RED,4), new ItemStack(Blocks.RED_FLOWER, 1, 0));
        addMillRecipe(getDye(EnumDyeColor.RED,4), new ItemStack(Blocks.RED_FLOWER, 1, 4));
        addMillRecipe(getDye(EnumDyeColor.YELLOW,4), new ItemStack(Blocks.YELLOW_FLOWER, 1, 0));
        addMillRecipe(getDye(EnumDyeColor.LIGHT_BLUE,4), new ItemStack(Blocks.RED_FLOWER, 1, 1));
        addMillRecipe(getDye(EnumDyeColor.MAGENTA,4), new ItemStack(Blocks.RED_FLOWER, 1, 2));
        addMillRecipe(getDye(EnumDyeColor.SILVER,4), new ItemStack(Blocks.RED_FLOWER, 1, 3));
        addMillRecipe(getDye(EnumDyeColor.ORANGE,4), new ItemStack(Blocks.RED_FLOWER, 1, 5));
        addMillRecipe(getDye(EnumDyeColor.SILVER,4), new ItemStack(Blocks.RED_FLOWER, 1, 6));
        addMillRecipe(getDye(EnumDyeColor.PINK,6), new ItemStack(Blocks.RED_FLOWER, 1, 7));
        addMillRecipe(getDye(EnumDyeColor.SILVER,4), new ItemStack(Blocks.RED_FLOWER, 1, 8));
        addMillRecipe(getDye(EnumDyeColor.YELLOW,6), new ItemStack(Blocks.DOUBLE_PLANT, 1, 0));
        addMillRecipe(getDye(EnumDyeColor.MAGENTA,6), new ItemStack(Blocks.DOUBLE_PLANT, 1, 1));
        addMillRecipe(getDye(EnumDyeColor.RED,6), new ItemStack(Blocks.DOUBLE_PLANT, 1, 4));
        addMillRecipe(getDye(EnumDyeColor.PINK,6), new ItemStack(Blocks.DOUBLE_PLANT, 1, 5));
