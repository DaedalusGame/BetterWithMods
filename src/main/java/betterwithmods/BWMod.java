...
@Mod(modid = "betterwithmods", name = "Better With Mods", version = "0.10 Beta", dependencies = "before:survivalist;after:tconstruct;after:minechem;after:natura;after:terrafirmacraft;after:immersiveengineering")
public class BWMod {
