...
public class MillRecipes extends Feature {
    ...
    public static int millstoneCraftSpeed;

    @Override
    public void setupConfig() {
        millstoneCraftSpeed = loadPropInt("Millstone Crafting Speed", "Speed at which the Millstone will finish a recipe in ticks", "", 1000, 200, 4000);
    }
